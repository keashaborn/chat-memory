#!/usr/bin/env python3
"""Build a private zero-write V5.1 relationship claim projection bundle."""
...
BUNDLE_CONTRACT = "memory_v1_relationship_claim_stage_bundle_v5_1"
...
async def run() -> int:
    ...
    if (
        ...
        raise RuntimeError("relationship claim preflight is stale or wrote data")
    bundle = {
