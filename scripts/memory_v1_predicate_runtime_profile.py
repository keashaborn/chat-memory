...
MANIFEST_CONTRACT = "memory_v1_predicate_runtime_profiles_v1"
MANIFEST_PATH = "specs/memory_v1_predicate_runtime_profiles_v1.json"
MANIFEST_SHA256 = (
    "e0f4e2c2e2afddbe61655ee6cbdb4734252213354ddff151270483ecfd8265d1"
)
PROFILE_NAMES = frozenset({"v5", "v5_1"})
...
def load_runtime_profile(
    ...
    return PredicateRuntimeProfile(
        name=profile_name,
