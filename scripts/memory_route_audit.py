...
def main() -> int:
    ...
    tests = [
        ...
        {
            "name": "fm_conceptual_nonexistence_consciousness",
            "body": {
                "user_id": "1240822d-ac9a-4096-95aa-e2b24d36ef50",
                "vantage_id": "RILEY",
                "message": "Could you describe the process of the emergence of consciousness from nonexistence?",
                "inspect_only": True,
                "debug": True,
                "mix": {
                    "conversation": 0.7,
        ...
        {
            "name": "durable_personal_card_preview_tech_suppression",
            "body": {
                "user_id": "1240822d-ac9a-4096-95aa-e2b24d36ef50",
                "vantage_id": "RESSE",
                "thread_id": "453de423-ce28-44d1-891c-2e82f5b2c164",
            ...
            "expect_personal_card_preview": {
                ...
                "candidate_count": 0,
                "selected_count": 0,
                "skip_reason": "turn_intent_suppresses_personal_cards:TECH",
            },
            "expect_system_prompt_false": [
        ...
        {
            "name": "durable_personal_card_preview_fm_conceptual_suppression",
            "body": {
                "user_id": "1240822d-ac9a-4096-95aa-e2b24d36ef50",
                "vantage_id": "RESSE",
                "thread_id": "453de423-ce28-44d1-891c-2e82f5b2c164",
            ...
            "expect_personal_card_preview": {
                ...
                "candidate_count": 0,
                "selected_count": 0,
                "skip_reason": "turn_intent_suppresses_personal_cards:FM_CONCEPTUAL",
            },
            "expect_system_prompt_false": [
                "[DURABLE PERSONAL CARDS]",
                "personal_card_selection_preview",
