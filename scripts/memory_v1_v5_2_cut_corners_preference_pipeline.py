...
ASSESSOR_REF = "controlled_v5_2_cut_corners_preference_20260725"
REVIEWER_TYPE = "system"
REVIEWER_REF = "controlled_v5_2_cut_corners_preference_20260725"
REVIEW_REASON = (
    "Owner-authored evidence explicitly states a stable work-style preference "
    "against cutting corners."
)
REASON_CODES = [
    "active_exact_owner_evidence",
    "explicit_life_preference",
    "stable_work_style_preference",
]
CONFIRMATION = "APPLY_ONE_OWNER_V5_2_CUT_CORNERS_PREFERENCE_ONLY"
EXPECTED_TABLE_ROWS = {
...
def validate_source(
    ...
    *,
    ...
    if (
        ...
        raise PipelineError("source is outside the exact cut-corners preference boundary")
...
def validate_packet_boundary(packet: dict[str, Any]) -> dict[str, Any]:
    ...
    expected_payload = {
        ...
        "preference_key": (
            "life.work_style."
            + hashlib.sha256("cut corners".encode()).hexdigest()[:24]
        ),
        "value": {"target": "cut corners", "context": None},
    ...
    if (
        ...
        raise PipelineError("deterministic cut-corners projection drifted")
    return projection
