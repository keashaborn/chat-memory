...
from memory_v1_v5_2_pet_claim_projection_shadow import (
    COLLECTION_PREFIX,
    load_points,
    shadow_tests,
)
...
REPORT_CONTRACT = "memory_v1_v5_2_pet_claim_projection_activation_result_v1"
        ...
        for item in items:
            row = await conn.fetchrow(
                ...
                SET status='processing'::memory.outbox_status,
                    ...
                    worker_id='controlled-pet-claim-activation',
