...
MANIFEST_CONTRACT = "memory_v1_v5_2_projection_review_manifest_v1"
RESULT_CONTRACT = "memory_v1_v5_2_projection_review_batch_result_v1"
...
def load_manifest(path: Path) -> dict[str, Any]:
    ...
    if (
        ...
        or value["reviewer_ref"] != "memory_v1_v5_2_stance_review_20260724"
...
async def run() -> int:
    ...
    if args.mode == "apply" and os.environ.get(
        "MEMORY_V1_V5_2_PROJECTION_REVIEW_APPLY", ""
    ) != "authorized":
