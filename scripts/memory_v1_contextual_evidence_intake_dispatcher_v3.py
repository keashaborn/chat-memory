...
CONTRACT_VERSION = "memory_v1_contextual_evidence_intake_dispatcher_v3"
SELECTOR_VERSION = "20260729_v4_contextual_resplit"
APPLY_CAPABILITY = "memory_v1_contextual_evidence_intake_apply_v3"
...
async def plan(
    ...
    if evidence_id is None:
        rows = await conn.fetch(
            """
            SELECT *
              FROM memory.plan_owner_contextual_chat_capture_v1($1,$2)
            """,
            selector_version,
            limit,
        )
