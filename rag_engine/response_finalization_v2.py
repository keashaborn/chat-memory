...
FINALIZED_LIFESWITCH_RESPONSE_VERSION = "finalized_trusted_response_v2"
...
class FinalizedTrustedResponseV2(_StrictFrozenModel):
    contract_version: Literal[FINALIZED_LIFESWITCH_RESPONSE_VERSION] = (
        FINALIZED_LIFESWITCH_RESPONSE_VERSION
    )
    answer_id: UUID
    ...
    def exact_finalization(self) -> "FinalizedTrustedResponseV2":
...
def finalize_trusted_response_v2(
    *,
    ...
    try:
        ...
        expected_request = OpenAIChatRequestV3.create(
            source_plan=plan,
        ...
        final_payload = {
            "contract_version": FINALIZED_LIFESWITCH_RESPONSE_VERSION,
            "answer_id": answer_id,
        ...
        return FinalizedTrustedResponseV2(
            answer_id=answer_id,
            output_kind=output_kind,
            assistant_text=text,
