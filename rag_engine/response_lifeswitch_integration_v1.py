...
TRUSTED_LIFESWITCH_RESPONSE_PLAN_VERSION = "trusted_response_plan_v0_6"
...
class TrustedLifeSwitchResponsePlanV1(_StrictFrozenModel):
    contract_version: Literal[TRUSTED_LIFESWITCH_RESPONSE_PLAN_VERSION] = (
        TRUSTED_LIFESWITCH_RESPONSE_PLAN_VERSION
    )
    ...
    assembled_prompt: AssembledPromptV2 = Field(repr=False)
    ...
    def exact_plan(self) -> "TrustedLifeSwitchResponsePlanV1":
        base = TrustedResponsePlanV0_2.model_validate_json(
            self.base_response_plan.model_dump_json()
        )
        assembled = AssembledPromptV2.from_wire_json(
    ...
    def create(
        ...
        *,
        ...
        augmentation = LifeSwitchPromptAugmentationRequestV1.create(
        ...
        assembled = assemble_prompt_with_lifeswitch_v1(augmentation)
        values = {
            "contract_version": TRUSTED_LIFESWITCH_RESPONSE_PLAN_VERSION,
...
__all__ = ["TrustedLifeSwitchResponsePlanV1"]
