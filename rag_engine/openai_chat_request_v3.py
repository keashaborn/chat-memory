...
OPENAI_CHAT_REQUEST_V3 = "openai_chat_request_v3"
OPENAI_CHAT_ADAPTER_V2 = "openai_chat_completions_lifeswitch_v1"
OPENAI_CHAT_RESPONSE_V3 = "openai_chat_response_v3"
REFERENCE_DATA_MESSAGE_V2 = "provider_reference_data_message_v2"
...
def _messages(
    plan: TrustedLifeSwitchResponsePlanV1,
...
class OpenAIChatRequestV3(_StrictFrozenModel):
    contract_version: Literal[OPENAI_CHAT_REQUEST_V3] = OPENAI_CHAT_REQUEST_V3
    adapter_version: Literal[OPENAI_CHAT_ADAPTER_V2] = OPENAI_CHAT_ADAPTER_V2
    source_plan: TrustedLifeSwitchResponsePlanV1 = Field(repr=False)
    ...
    @model_validator(mode="after")
    def exact_request(self) -> "OpenAIChatRequestV3":
    ...
    def create(
        cls,
        *,
        source_plan: TrustedLifeSwitchResponsePlanV1,
        ...
        values = {
            "contract_version": OPENAI_CHAT_REQUEST_V3,
            "adapter_version": OPENAI_CHAT_ADAPTER_V2,
            "source_plan": plan,
...
class OpenAIChatCompletionsAdapterV2:
    ...
    def complete(
        ...
        *,
        ...
        request = OpenAIChatRequestV3.create(
            source_plan=plan,
