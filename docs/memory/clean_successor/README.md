...
The current inactive store target is generation `000003`: PostgreSQL
`127.0.0.1:55434`, Qdrant `127.0.0.1:6345`, and collection
`governed_memory_9a54cf123493_000003`. Generation `000001` is retained only as
