#!/usr/bin/env python3
"""Generate deterministic synthetic fixtures for the V5 stage-batch clone test."""
...
def authorize(plan_path: Path, output: Path, head: str) -> None:
    ...
    value = {
        "contract_version": "memory_v1_v5_stage_batch_authorization_v1",
        ...
        "target_server": "seebx",
        "scope": "stage_reviewed_owner_v5_packets_only",
