...
BEGIN
  ...
  FOREACH function_oid IN ARRAY ARRAY[
    ...
    'memory.reconcile_entity_resolution_v5_2(uuid,uuid,uuid,uuid,text)'::regprocedure,
    'memory.preflight_entity_resolution_review_v5_2(uuid,memory.entity_review_decision,text)'::regprocedure,
    'memory.review_entity_resolution_v5_2(uuid,uuid,memory.entity_review_decision,text)'::regprocedure,
