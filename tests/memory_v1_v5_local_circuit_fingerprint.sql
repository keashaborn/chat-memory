...
BEGIN
  ...
  IF function_sha<>'01052eb7ea5a2add2a9795bcc960408a7702fdc1baee83e17b12722889307970' THEN
...
-- A new compiler fingerprint is not blocked by an older compiler's failures.
