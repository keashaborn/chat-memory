...
from scripts.memory_v1_v5_2_entity_resolution_batch import CONFIRMATION
...
def main() -> int:
    ...
    plan_sha = digest(raw)
    value = {
        "contract_version": "memory_v1_v5_2_entity_resolution_batch_authorization_v1",
        "authorization_id": str(
            uuid.uuid5(
                uuid.UUID("7d0bca20-a734-5b9d-a414-c721e7001681"), plan_sha
            )
        ),
        "authorized": True,
        ...
        "target_server": "seebx",
        "scope": "reconcile_review_and_apply_owner_v5_2_entity_resolutions_only",
