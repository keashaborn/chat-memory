...
from scripts.memory_v1_v5_2_stage_batch import (
    StageBatchError,
    apply_once,
...
from scripts.memory_v1_v5_1_stage_preflight import (
    ...
    _validate_extraction_packet as validate_profiled_extraction,
)
...
class StageBatchTest(unittest.TestCase):
    ...
    def test_v5_and_v5_2_packet_lanes_are_mutually_exclusive(self):
        v5_2 = json.loads(empty_bundle()["extraction_packet_text"])
        validate_profiled_extraction(
            v5_2,
    ...
    def test_apply_sets_actor_and_owner_lock(self):
        ...
        self.assertEqual(connection.calls[1][2], (f"{OWNER}|relational_stage_v5_2",))
