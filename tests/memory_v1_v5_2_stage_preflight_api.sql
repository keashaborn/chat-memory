...
BEGIN
  BEGIN
    PERFORM * FROM memory.preflight_relational_stage_bundle_v5_2(
      '3eeeeeee-3333-4333-8333-333333333333',
      '33333333-0001-4000-8000-000000000001',
...
BEGIN
  ...
  IF to_regprocedure(
    ...
    RAISE EXCEPTION 'V5.2 controlled stage API ownership or ACL is invalid';
  END IF;
  ...
  IF EXISTS (
    ...
    RAISE EXCEPTION 'PUBLIC can execute V5.2 controlled stage API';
  END IF;
  ...
  IF to_regprocedure(
    ...
    RAISE EXCEPTION 'V5/V5.1 APIs were altered or removed';
  END IF;
  ...
  IF registry_constraint IS NULL
     ...
     OR position('memory_predicate_registry_v5_1' IN registry_constraint)=0
     OR position('memory_predicate_registry_v5_2' IN registry_constraint)=0 THEN
    RAISE EXCEPTION 'entity-resolution registry constraint is not exact V5/V5.1/V5.2';
  END IF;
END
$security$;
...
SELECT 'memory_v1_v5_2_stage_preflight_api: PASS' AS result;
