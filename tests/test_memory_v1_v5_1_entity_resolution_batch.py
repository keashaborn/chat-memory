...
from scripts.memory_v1_v5_1_entity_resolution_batch import (
...
class V51EntityResolutionBatchManifestTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def manifest(self) -> dict:
        return {
            "contract_version": "memory_v1_v5_1_entity_resolution_batch_manifest_v1",
            "target_server": "seebx",
            "owner_user_id": OWNER,
    ...
    def test_accepts_exact_v5_1_row_budget(self) -> None:
