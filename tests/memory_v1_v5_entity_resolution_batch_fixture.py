...
from scripts.memory_v1_v5_entity_resolution_batch import CONFIRMATION
...
def main() -> int:
    ...
    plan_sha = digest(raw)
    value = {
        "contract_version": "memory_v1_v5_entity_resolution_batch_authorization_v1",
        ...
        "target_server": "seebx",
        "scope": "review_and_apply_owner_v5_entity_resolutions_only",
