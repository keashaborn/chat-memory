...
# seebx backend only. Admits and projects the exact reviewed canonical-name
# claim, then
...
if [[ "${MEMORY_V1_V5_2_CANONICAL_NAME_PROJECTION:-}" != authorized ]]; then
  echo 'MEMORY_V1_V5_2_CANONICAL_NAME_PROJECTION=authorized is required' >&2
  exit 1
fi
...
lock_file=/home/ubuntu/brains/.memory_v1_v5_2_canonical_name_projection.lock
...
printf 'memory_v1_v5_2_canonical_name_projection_production: PASS\n'
