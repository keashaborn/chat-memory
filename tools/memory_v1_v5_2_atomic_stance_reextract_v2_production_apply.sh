...
if [[ "${MEMORY_V1_V5_2_ATOMIC_STANCE_REEXTRACT_RUN:-}" != authorized ]]; then
  echo 'MEMORY_V1_V5_2_ATOMIC_STANCE_REEXTRACT_RUN=authorized is required' >&2
  exit 1
fi
...
lock_file=/home/ubuntu/brains/.memory_v1_v5_2_atomic_stance_reextract_v2.lock
...
selector=20260722_v5_2_atomic_stance_reextract_v2
...
clone_test=tools/memory_v1_v5_2_atomic_stance_reextract_v2_clone.sh

declare -A expected_sha256=(
  ["$migration"]="4f2d849877de8b17085a205e5687a7db8e63f5904632b94371bf34638eda5f97"
  ["$rollback"]="c17cc1cc9c3d682e74bd7fe92983aa4cbf0ffd85bc4492aac2be363c5eaa74e3"
  ["$test_sql"]="18275ca327c1edf100d15929b6193a80a155c74806d20f68dca0d23af83ddf19"
  ["$worker"]="29ea6c6c25cc756d4646dd716ef1c00881a989f70c135513e1c5f5c7d083aeb5"
  ["$provider"]="8a746fb2f1252b7c8c4380c7d242f561b36acdf83e2e5d4bf707d2e75e4273bc"
  ["$provider_test"]="2ccce6102afd2d1bfda3b5b19737faec1fb7d3260b52c0981dee1e90464114f5"
  ["$clone_test"]="9894e175143a1b5b754d0aebbe748facf6db2bfde5cce9fb0eb626c769ecc3e8"
)
...
status_file="$snapshot_dir/memory_v1_v5_2_atomic_stance_reextract_v2_${run_tag}.status"
report="$snapshot_dir/memory_v1_v5_2_atomic_stance_reextract_v2_${run_tag}.json"
...
phase=fresh_backup
partial="$snapshot_dir/.memory_pre_v5_v5_2_atomic_stance_reextract_v2_${run_tag}.dump.partial"
backup="$snapshot_dir/memory_pre_v5_v5_2_atomic_stance_reextract_v2_${run_tag}.dump"
...
jq -n --arg completed_at "$(date -u +%Y-%m-%dT%H:%M:%SZ)" \
  ...
  '{contract_version:"memory_v1_v5_2_atomic_stance_reextract_v2_apply_report_v1",
...
phase=complete
printf '%s\nreport=%s\nbackup=%s\n' \
  'memory_v1_v5_2_atomic_stance_reextract_v2_production_apply: PASS' \
  "$report" "$backup"
