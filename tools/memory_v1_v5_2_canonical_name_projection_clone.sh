...
# seebx backend only. Clone-tests the exact canonical-name deferred projection
...
jq -n \
  ...
  '{
    contract_version:"memory_v1_v5_2_canonical_name_projection_clone_report_v1",
    head_commit:$head,
...
printf 'memory_v1_v5_2_canonical_name_projection_clone: PASS\n'
