...
port=${MEMORY_V1_V5_2_ENTITY_BATCH_CLONE_PORT:-55473}
export MEMORY_V1_V5_2_ENTITY_BATCH_CLONE_PORT="$port"
# The shared Compose file intentionally retains its established variable name.
export MEMORY_V1_STAGE_BATCH_CLONE_PORT="$port"
compose=(
  docker compose
  -p memoryv1v52entitybatchclone
...
echo "memory_v1_v5_2_entity_resolution_batch_production_clone: PASS"
