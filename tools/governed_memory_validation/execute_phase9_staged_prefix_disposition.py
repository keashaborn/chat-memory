...
"""Execute the exact Phase 9 v9 staged-prefix-to-v10 disposition."""
...
BASE_CANDIDATE_COMMIT: Final = "ddbbf1ac6c1ed6c58f8b1ea8701a5803f49c6065"
BASE_CANDIDATE_TREE: Final = "446a5adfb1096ef672b13e3fda82ec8e8275bb1e"
...
PERMIT_PATH: Final = Path(
    "/var/lib/governed-memory-controller/phase9j-pre-effect-disposition-permit-000006.json"
)
STATE_ROOT: Final = Path("/var/lib/governed-memory-controller")
CONTRACT_ROOT: Final = STATE_ROOT / "pre-effect-dispositions"
CONTRACT_PATH: Final = (
    CONTRACT_ROOT / "phase9-v9-staged-to-v10-000006.contract.json"
)
...
FAILED_TAG_COMMIT: Final = "ddbbf1ac6c1ed6c58f8b1ea8701a5803f49c6065"
FAILED_TAG_TREE: Final = "446a5adfb1096ef672b13e3fda82ec8e8275bb1e"
...
CORRECTED_GENERATION: Final = "000006"
ROOT_UID: Final = 0
ROOT_GID: Final = 0
