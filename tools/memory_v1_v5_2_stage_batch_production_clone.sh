...
port=${MEMORY_V1_V5_2_STAGE_BATCH_CLONE_PORT:-55440}
export MEMORY_V1_V5_2_STAGE_BATCH_CLONE_PORT="$port"
# The shared Compose file intentionally retains its established variable name.
export MEMORY_V1_STAGE_BATCH_CLONE_PORT="$port"
compose=(
  docker compose
  -p memoryv1v52stagebatchclone
...
unit_test=tests/test_memory_v1_v5_2_stage_batch.py
...
echo "memory_v1_v5_2_stage_batch_production_clone: PASS"
