...
EXPECTED_PHASE9J_RUNTIME_TREE_SHA256 = (
    "2019acceeb09e97b3bc9e3c77fccdba6a75d55f7ebf361fdc90fd90f155eccdf"
)
EXPECTED_PHASE9J_RELEASE_TREE_SHA256 = (
    "b9260d334bde9ca479dd8bbca4a848aa07831f048430281d9b54fc46381ae12e"
)
EXPECTED_CURRENT_RUNTIME_MANIFEST_SHA256 = (
    "813e93170fae2819625455c2874da44660669202a5f790f8ae8290205ba76575"
)
...
EXACT_TARGETS = {
    "postgres_container": "governed-memory-postgres-9a54cf123493-000004",
    "qdrant_container": "governed-memory-qdrant-9a54cf123493-000004",
    "postgres_volume": "governed-memory-postgres-data-9a54cf123493-000004",
    "qdrant_volume": "governed-memory-qdrant-data-9a54cf123493-000004",
    "network": "governed-memory-net-9a54cf123493-000004",
    "database": "governed_memory",
    "collection": "governed_memory_9a54cf123493_000004",
...
def _verify_runtime_manifest(
    ...
    _require(
        ...
        and phase9j_target.get("database_target") == "127.0.0.1:55435"
        and phase9j_target.get("qdrant_target") == "127.0.0.1:6346"
