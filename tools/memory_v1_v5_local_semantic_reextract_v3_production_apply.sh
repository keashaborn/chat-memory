...
if [[ "${MEMORY_V1_V5_LOCAL_SEMANTIC_REEXTRACT_V3_RUN:-}" != authorized ]]; then
  echo 'MEMORY_V1_V5_LOCAL_SEMANTIC_REEXTRACT_V3_RUN=authorized is required' >&2
  exit 1
fi
...
lock_file=/home/ubuntu/brains/.memory_v1_v5_local_semantic_reextract_v3.lock
required_ancestor=e4069b2dcb294e963e2abdb5bd4191105ad40982
...
selector=20260720_v5_semantic_guard_reextract_v1
...
rollback=ops/sql/20260720_memory_v1_v5_local_semantic_reextract_v3_rollback.sql
...
clone_test=tools/memory_v1_v5_local_semantic_reextract_v3_clone.sh

declare -A expected_sha256=(
  ["$migration"]="d12be03a099d9acb42f0a00aeeb4a14e02d1337c5cd399de26b47aa45f8efa16"
  ["$rollback"]="b71f22f80f80e3385ef9f43973d9c1e3cec7aa15452ec51e8f796baf220a2223"
  ["$test_sql"]="12d2f545feb100f15dc311be6761bea58b2f758e11c6e9029d00a208f30e9246"
  ["$worker"]="e260fde5484450371742b61f8d662fa97bd1f1fd25c6f71ab3666f3ce1374556"
  ["$provider"]="30f6c31f8fff4696d19a23060465c359884a9374215c1b490a86da680a4df997"
  ["$provider_test"]="2ccce6102afd2d1bfda3b5b19737faec1fb7d3260b52c0981dee1e90464114f5"
  ["$clone_test"]="3f8f6a31488207ce478a30d970877b5636def081ba5f368e6c89ecc105ac724f"
)

timer_state=$(mktemp /tmp/memory-v5-semantic-reextract-v3-timers.XXXXXX)
table_list=$(mktemp /tmp/memory-v5-semantic-reextract-v3-tables.XXXXXX)
before=$(mktemp /tmp/memory-v5-semantic-reextract-v3-before.XXXXXX)
after=$(mktemp /tmp/memory-v5-semantic-reextract-v3-after.XXXXXX)
dry=$(mktemp /tmp/memory-v5-semantic-reextract-v3-dry.XXXXXX)
applied=$(mktemp /tmp/memory-v5-semantic-reextract-v3-applied.XXXXXX)
clone_output=$(mktemp /tmp/memory-v5-semantic-reextract-v3-clone.XXXXXX)
...
status_file="$snapshot_dir/memory_v1_v5_local_semantic_reextract_v3_${run_tag}.status"
report="$snapshot_dir/memory_v1_v5_local_semantic_reextract_v3_${run_tag}.json"
...
phase=fresh_backup
partial="$snapshot_dir/.memory_pre_v5_semantic_reextract_v3_${run_tag}.dump.partial"
backup="$snapshot_dir/memory_pre_v5_semantic_reextract_v3_${run_tag}.dump"
...
jq -n --arg completed_at "$(date -u +%Y-%m-%dT%H:%M:%SZ)" \
  ...
  '{contract_version:"memory_v1_v5_local_semantic_reextract_v3_apply_report_v1",
...
phase=complete
printf '%s\nreport=%s\nbackup=%s\n' \
  'memory_v1_v5_local_semantic_reextract_v3_production_apply: PASS' \
  "$report" "$backup"
