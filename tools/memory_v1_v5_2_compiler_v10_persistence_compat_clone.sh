...
production=memory
clone="memory_v5_2_compiler_v10_persistence_compat_${$}"
migration=ops/sql/20260731_memory_v1_v5_2_compiler_v10_persistence_compat.sql
rollback=ops/sql/20260731_memory_v1_v5_2_compiler_v10_persistence_compat_rollback.sql
test_sql=tests/memory_v1_v5_2_compiler_v10_persistence_compat.sql
old_sha=2b3182f59091a7d93697ae79ee6a8e1cc7541829f957b5a859c47cf28707d190
new_sha=8273a2de6dcdb4509c572580670d9bc34474b1b8988bc4172f9d29ae66995c3a
backup=$(mktemp /tmp/memory-v5-2-compiler-v10-persistence.XXXXXX.dump)
chmod 0600 "$backup"
...
printf '%s\n' 'memory_v1_v5_2_compiler_v10_persistence_compat_clone: PASS'
