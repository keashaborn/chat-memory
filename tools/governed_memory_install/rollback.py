...
EMPTY_ROLLBACK_STEPS: Final = (
    ...
    EmptyRollbackPlanStep("R05_RECHECK_SEMANTIC_EMPTY_UNDER_CONTROLLER_AUTHORITY_MARKER", "recheck_semantic_empty_under_controller_authority_marker", None),
    EmptyRollbackPlanStep("R06_DISABLE_AND_REMOVE_STORES_SUPERVISOR", "disable_and_remove_stores_supervisor", "stores_supervisor"),
