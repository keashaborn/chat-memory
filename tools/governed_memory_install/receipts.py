...
ROLLBACK_RECEIPT_SCHEMA: Final = "governed-memory-empty-store-rollback-receipt-v4"
...
def build_empty_rollback_receipt(
    *,
    ...
    exact_rollback_resources_absent_count: int,
) -> dict[str, object]:
    receipt: dict[str, object] = {
...
def verify_empty_rollback_receipt(
    ...
    if (
        ...
        or receipt["exact_rollback_resources_absent_count"]
