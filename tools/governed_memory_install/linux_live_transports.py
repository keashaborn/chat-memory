...
POSTGRES_CONTAINER: Final = "governed-memory-postgres-9a54cf123493-000004"
QDRANT_CONTAINER: Final = "governed-memory-qdrant-9a54cf123493-000004"
POSTGRES_VOLUME: Final = "governed-memory-postgres-data-9a54cf123493-000004"
QDRANT_VOLUME: Final = "governed-memory-qdrant-data-9a54cf123493-000004"
DOCKER_NETWORK: Final = "governed-memory-net-9a54cf123493-000004"

QDRANT_BIND: Final = "127.0.0.1:6346"
QDRANT_COLLECTION: Final = "governed_memory_9a54cf123493_000004"
QDRANT_ALIAS: Final = "governed_memory_active"

SYSTEMD_UNIT_PATH: Final = "/etc/systemd/system/governed-memory-stores-v4.service"
SYSTEMD_ENABLEMENT_PATH: Final = (
    "/etc/systemd/system/multi-user.target.wants/governed-memory-stores-v4.service"
)
...
ROOT_FILE_SLOTS: Final[Mapping[RootFileSlot, RootFileSlotContract]] = MappingProxyType(
    {
        ...
        RootFileSlot.TERMINAL_POSTFLIGHT_RECEIPT: RootFileSlotContract(
            ...
            "/var/lib/governed-memory-controller/executions-v4/{execution_id}/terminal-postflight-receipt.json",
            RootNodeKind.REGULAR_FILE,
            0o600,
            64 * 1024,
            (
                ...
                SafeAncestorContract(
                    "/var/lib/governed-memory-controller/executions-v4", frozenset({0o700})
                ),
                SafeAncestorContract(
                    "/var/lib/governed-memory-controller/executions-v4/{execution_id}",
                    frozenset({0o700}),
                ),
            ),
        ),
        RootFileSlot.ROLLBACK_CONTROLLER_AUTHORITY_MARKER: RootFileSlotContract(
            RootFileSlot.ROLLBACK_CONTROLLER_AUTHORITY_MARKER,
            "/var/lib/governed-memory-controller/executions-v4/{execution_id}/empty-rollback-controller-authority-marker.json",
            RootNodeKind.REGULAR_FILE,
            0o400,
            64 * 1024,
            (
        ...
        RootFileSlot.ROLLBACK_SEMANTIC_EMPTY_PROOF: RootFileSlotContract(
            RootFileSlot.ROLLBACK_SEMANTIC_EMPTY_PROOF,
            "/var/lib/governed-memory-controller/executions-v4/{execution_id}/empty-rollback-semantic-empty-proof.json",
            RootNodeKind.REGULAR_FILE,
            0o400,
            64 * 1024,
            (
        ...
        RootFileSlot.SYSTEMD_DAEMON_RELOAD_PENDING: RootFileSlotContract(
            RootFileSlot.SYSTEMD_DAEMON_RELOAD_PENDING,
            "/var/lib/governed-memory-controller/executions-v4/{execution_id}/systemd-daemon-reload-pending.json",
            RootNodeKind.REGULAR_FILE,
            0o400,
            64 * 1024,
            (
...
_CREATE_ALIAS_BODY: Final = (
    ...
    b'"collection_name":"governed_memory_9a54cf123493_000004"}}]}'
)
