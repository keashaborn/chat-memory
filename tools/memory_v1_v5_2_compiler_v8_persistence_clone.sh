...
production=memory
clone="memory_v5_2_compiler_v8_persistence_${$}"
migration=ops/sql/20260725_memory_v1_v5_2_compiler_v8_persistence.sql
test_sql=tests/memory_v1_v5_2_compiler_v8_persistence.sql
backup=$(mktemp /tmp/memory-v5-2-compiler-v8-persistence.XXXXXX.dump)
chmod 0600 "$backup"
