#!/usr/bin/env python3
"""Verify the exact candidate file set and SHA-256 manifest."""
...
def main() -> int:
    ...
    if observed != expected:
        raise RuntimeError("candidate file set or hash diverged")
...
if __name__ == "__main__":
    try:
        ...
        print("manifest verification failed: " + type(error).__name__ + ": " + str(error), file=sys.stderr)
        raise SystemExit(2)
