CREATE FUNCTION memory.apply_owner_openai_review_admission_v1(p_entity_resolution_request_id uuid, p_route_event_id uuid, p_expected_stage_bundle_sha256 text, p_reviewer_type text, p_reviewer_ref text, p_reason text, p_reason_codes jsonb, p_admission_manifest_sha256 text)
...
BEGIN
  ...
  new_observation_id:=(staged.result#>>'{observation_ids,o01}')::uuid;
  new_resolution_id:=(staged.result#>>'{resolution_ids,e01}')::uuid;
