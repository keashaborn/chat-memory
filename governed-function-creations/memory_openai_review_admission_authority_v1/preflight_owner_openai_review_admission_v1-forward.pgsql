CREATE FUNCTION memory.preflight_owner_openai_review_admission_v1(p_route_event_id uuid, p_expected_stage_bundle_sha256 text, p_reviewer_type text, p_reviewer_ref text, p_reason text, p_reason_codes jsonb)
...
BEGIN
  ...
  IF observation->>'observation_ref'<>'o01'
  ...
  RETURN QUERY SELECT source.route_event_id,source.packet_id,source.job_id,
    source.evidence_id,(bundle->>'request_id')::uuid,'o01'::text,
