...
BEGIN
  IF current_user<>'sage' THEN
    RAISE EXCEPTION 'exact-job retry5 rollback requires sage';
  END IF;
  ...
  IF before_sha<>'e67b5bbd08e9eb40283b29ee436f8aec6e3633439d65fb5897d2bc9ef9938b09'
    ...
    RAISE EXCEPTION 'exact-job claim function drifted before retry5 rollback';
  END IF;
  ...
  IF after_sha<>'a694fc38a54422dea43f184f98a3576253b6a0083e47043d85d63c964813c312'
    ...
    RAISE EXCEPTION 'exact-job retry5 rollback postcondition failed';
  END IF;
END
$rollback$;
