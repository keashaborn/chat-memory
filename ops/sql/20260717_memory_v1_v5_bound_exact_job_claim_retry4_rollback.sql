...
BEGIN
  IF current_user<>'sage' THEN
    RAISE EXCEPTION 'exact-job retry4 rollback requires sage';
  END IF;
  ...
  IF before_sha<>'a694fc38a54422dea43f184f98a3576253b6a0083e47043d85d63c964813c312'
    ...
    RAISE EXCEPTION 'exact-job claim function drifted before retry4 rollback';
  END IF;
  ...
  IF after_sha<>'e680f5972b124b96df1a2af20347c0182409a8ec385e50f59883dff32445ba3f'
    ...
    RAISE EXCEPTION 'exact-job retry4 rollback postcondition failed';
  END IF;
END
$rollback$;
