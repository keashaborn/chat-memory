...
BEGIN
  ...
  IF NOT (
       (
         p_normalized_packet->>'contract_version'
           ='memory_v1_relational_extraction_v5'
         AND p_normalized_packet->>'predicate_registry_version'
         ...
         AND p_provider_id='openai_responses'
         AND p_provider_version='v1'
         AND p_external_model_calls=1
       )
     )
